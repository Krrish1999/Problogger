    ...
    <div className="border-slate-200 border-b px-10 py-4 flex justify-between">
      ...
      <div className="flex items-center">
        {isPublishPage ? (
          ...
          <Link to="/publish">
            <button className="mr-6 text-slate-700 flex font-medium py-1 px-3 text-md cursor-pointer rounded-full border border-slate-400 transform hover:scale-105 transition-transform duration-200">
